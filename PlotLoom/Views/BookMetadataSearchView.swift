                ...
                if isSearching {
                    ...
                    VStack(spacing: 14) {
                        Image(systemName: "wifi.exclamationmark")
                            .font(.system(size: 42))
                            .foregroundStyle(PlotLoomStyle.coral)
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                HStack(spacing: 8) {
                    if let publishedYear = candidate.publishedYear {
                        TintedCapsuleLabel(text: "\(publishedYear)", tint: PlotLoomStyle.sage, horizontalPadding: 8, verticalPadding: 4)
                    }
                    TintedCapsuleLabel(text: candidate.provider.displayName, tint: PlotLoomStyle.plum, horizontalPadding: 8, verticalPadding: 4)
                }
