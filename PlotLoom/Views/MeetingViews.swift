    ...
    var body: some View {
        HStack(spacing: 12) {
            Image(systemName: meeting.isCompleted ? "calendar.badge.checkmark" : "calendar")
                ...
                .foregroundStyle(meeting.isCompleted ? PlotLoomStyle.sage : PlotLoomStyle.indigo)
            ...
            TintedCapsuleLabel(text: "\(acceptedCount) going", tint: PlotLoomStyle.sage, horizontalPadding: 7, verticalPadding: 3)
        }
